...
$('#loading').hide()
$('#listrecords').html('<h3>' + j.opaResponse.results['total'] + ' series:</h3>' + titles);
$('#listrecords').show()
...
$('#loading').show()
load();
$('#nowviewing').html('<h2>Now viewing: <button class="button" href="#" onclick="up(' + filenaid + ')">^ File unit "' + filename + '"</h2>')
// <button class="accordion">Section 1</button>
// <div class="panel">
//   <p>Lorem ipsum...</p>
// </div>
